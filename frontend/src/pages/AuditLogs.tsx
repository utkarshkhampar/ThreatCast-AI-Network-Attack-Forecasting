...
export const AuditLogs: React.FC = () => {
  ...
  useEffect(() => {
    fetch('/api/v1/audit')
      .then(r => r.json())
      .catch(() => [
        { id: "AUD-1001", timestamp: "2026-09-05T06:30:12Z", actor: "admin", action: "USER_LOGIN", target: "SOC Console", outcome: "SUCCESS", ip_address: "192.168.1.100", details: "MFA Verified" },
        { id: "AUD-1002", timestamp: "2026-09-05T06:31:05Z", actor: "SYSTEM_WORLD_MODEL", action: "FORECAST_GENERATED", target: "AST-WK-42", outcome: "SUCCESS", ip_address: "127.0.0.1", details: "5-step forward rollout computed, prob=0.91" },
        { id: "AUD-1003", timestamp: "2026-09-05T06:32:44Z", actor: "analyst1", action: "DEFENSIVE_POLICY_EVALUATED", target: "192.168.1.45", outcome: "AUTHORIZED_DRY_RUN", ip_address: "192.168.1.102", details: "Allow-list and RBAC checks verified" }
      ])
      .then(setLogs);
  }, []);
